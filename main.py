...
def parse_opt():
    ...
    parser.add_argument('--task', type=str, required=True, action='store', choices=['train', 'test'], default='train', help="Perform the choosen task, 'train' for training, 'test' for evaluate on test set")
    parser.add_argument('--data', type=str, required=True, action='store', help="Path to DATA configuration .yaml")
    parser.add_argument('--model', type=str, required=True, action='store', help="Path to MODEL configuration .yaml")
    parser.add_argument('--trainer', type=str, required=True, action='store', help="Path to TRAINER configuration .yaml")
